            ...
            .authorizeHttpRequests(auth ->
                auth
                    ...
                    .requestMatchers(
                        ...
                        AntPathRequestMatcher.antMatcher(HttpMethod.POST,"/api/game"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/api/game"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/api/game/**"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/api/map"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/api/map/**"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.POST,"/api/map"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.PUT,"/api/map/**"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.POST,"/api/round"),
                        AntPathRequestMatcher.antMatcher(HttpMethod.POST,"/api/coordinate")
